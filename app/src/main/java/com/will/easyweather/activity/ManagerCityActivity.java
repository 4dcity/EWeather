...
import com.will.easyweather.view.DragSortGridView;
...
public class ManagerCityActivity extends BaseActivity implements
	...
	protected void onPause() {
		super.onPause();
		L.i("Will", ManagerCityActivity.this.getClass().getName()
				+ " onPause...");
	...
	protected void onStop() {
		super.onStop();
		L.i("Will", "ManagerCityActivity onStop...");
	}
	...
	private void updateRefreshMode(boolean isRefresh) {
		if (isRefresh && NetUtil.getNetworkState(this) == NetUtil.NET_NONE) {
	...
	private DragSortGridView.OnReorderingListener dragSortListener = new DragSortGridView.OnReorderingListener() {
		...
		public void onReordering(int fromPosition, int toPosition) {
			L.d("Will", "onReordering fromPosition:" + fromPosition
			...
			case ADD_CITY_TYPE:
				holder.addView.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						L.i("Will", "addView.onClickListener...");
	...
	private final class GridCityRefreshTask extends
		...
		public GridCityRefreshTask(City city) {
			...
			L.i("Will", "GridCityRefreshTask index = " + mTaskIndex);
		}
		...
		protected void onPreExecute() {
			...
			L.i("Will", "onPreExecute begin refreshing index = 0");
		}
		...
		protected void onPostExecute(WeatherInfo result) {
			...
			L.i("Will", "onPostExecute reset refreshing index = -1");
		...
		protected void onProgressUpdate(Integer... values) {
			...
			L.i("Will", "refreshing index = " + values[0]);
