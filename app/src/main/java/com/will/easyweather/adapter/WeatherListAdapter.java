...
import com.will.easyweather.util.LunarCalendar;
import com.will.easyweather.util.LunarCalendarConvertUtil;
import com.will.easyweather.util.TimeUtils;
import com.will.easyweather.weather.WeatherIconUtils;

/**
 * 因为这个 List 里的 item 是固定的4个：Realtime，AQI，Forecast，Index
 * 所以绑定数据到 viewholder 的时候，不需要在用 getItem（position）来获得当前位置的 item 数据
 * 另外这里也偷懒只用了一个 viewholder 包含了所有的 view，而没有分成4个 viewholder
 */
public class WeatherListAdapter extends BaseAdapter {
	...
	//这里偷懒只用了一个 viewholder 来保存所有的 ui
