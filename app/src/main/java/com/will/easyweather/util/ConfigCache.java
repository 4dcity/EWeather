	...
	public static File getCacheDir(Context context) {
		...
		if (Environment.getExternalStorageState().equals(
			...
			cacheDir = new File(Environment.getExternalStorageDirectory()
					.getAbsolutePath() + File.separator + "EWeather");
			if (!cacheDir.exists())
				cacheDir.mkdir();
		}
		return cacheDir;
